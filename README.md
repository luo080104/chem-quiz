...
> 当前题库：**200 题**（1a+1b，均含答案/解析/翻译/难词）。老师另有 50 题待补，到齐后升级正式“250 抽 100”。
> 待老师确认的 6 处答案分歧见 [`docs/问老师清单_待确认题.md`](docs/问老师清单_待确认题.md)。
...
- 首次在线打开后会自动缓存应用与题库，之后可断网刷题（需真机断网复验）。
- 题库更新后，联网打开一次即刷新到最新。
...
| PWA / 断网刷题 | ✅ 已实现 | 可“添加到主屏幕”；首次在线打开后缓存，支持断网刷题（需真机断网复验） |
| 答案对照（本次AI vs 手机） | ✅ 已实现 | 待核清单页显示两版答案与“分歧”标记 |
| 标记不懂 | ✅ 已实现 | 练习结果页可标记，错题页汇总 |
